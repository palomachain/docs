...
### Mainnet
On mainnet `tumbler` the latest tag is v1.15.1


```sh
wget -O - https://github.com/palomachain/paloma/releases/download/v1.15.1/paloma_Linux_x86_64.tar.gz  | \
...
### Testnet
On testnet `paloma-testnet-16` the latest tag is v1.15.1
