...
### Mainnet
On mainnet `messenger` the latest tag is v1.12.1


```sh
wget -O - https://github.com/palomachain/paloma/releases/download/v1.12.1/paloma_Linux_x86_64.tar.gz  | \
...
### Testnet
On testnet `paloma-testnet-15` the latest tag is v1.12.1
