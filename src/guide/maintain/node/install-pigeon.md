...
### Mainnet
On mainnet `tumbler` the latest tag is v2.3.5

```bash
wget -O - https://github.com/palomachain/pigeon/releases/download/v2.3.5/pigeon_Linux_x86_64.tar.gz | \
...
On testnet `paloma-testnet-17` the latest tag is v2.3.5
