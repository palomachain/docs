...
### Mainnet
On mainnet `messenger` the latest tag is v1.9.4

```bash
wget -O - https://github.com/palomachain/pigeon/releases/download/v1.9.4/pigeon_Linux_x86_64.tar.gz | \
...
### Testnet
On testnet `paloma-testnet-15` the latest tag is v1.9.4
