...
When a new module is added to Paloma, you must add it to several places in Paloma.js too. To add it, complete the following steps:
...
Paloma.js provides an easy way to generate `ParameterChangeProposal`s, which is a proposal for changing the blockchain parameters associated with a module. If your module has parameters that can be changed via proposal, you should create the following files:
