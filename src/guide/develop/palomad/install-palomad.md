...
### Mainnet
On mainnet `tumbler` the latest tag is v2.4.8

```sh
wget -O - https://github.com/palomachain/paloma/releases/download/v2.4.8/paloma_Linux_x86_64.tar.gz  | \
...
### Testnet
On testnet `paloma-testnet-17` the latest tag is v2.4.8
