...
The genesis parameters for the staking module outlined in the [Genesis Builder Script](https://github.com/paloma/genesis-tools/blob/main/src/genesis_builder.py#L132) are as follows:
