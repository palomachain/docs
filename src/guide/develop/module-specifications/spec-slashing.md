...
The genesis parameters for the crisis module outlined in the [Genesis Builder Script](https://github.com/paloma/genesis-tools/blob/main/src/genesis_builder.py#L168) are as follows:
