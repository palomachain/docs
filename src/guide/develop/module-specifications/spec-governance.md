...
To learn how to vote with your staked GRAIN or submit proposals, 
visit the [governance guide](../../maintain/governance/proposals.md).
...
The genesis parameters for the governance module outlined in the [Genesis Builder Script](https://github.com/paloma/genesis-tools/blob/main/src/genesis_builder.py#L147) are as follows:
